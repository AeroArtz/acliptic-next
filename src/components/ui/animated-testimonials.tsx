    ...
    <div className="max-w-sm md:max-w-4xl mx-auto antialiased px-4 md:px-8 lg:px-12 py-20">
      <div className="relative grid grid-cols-1 md:grid-cols-2 gap-20">
        ...
        <div className="flex justify-between flex-col py-4">
          ...
          >
            <h3 className="text-4xl font-medium dark:text-white text-black">
              {testimonials[active].name}
            </h3>
            <p className="text-sm text-gray-500 dark:text-neutral-500 hel-font">
              {testimonials[active].designation}
            </p>
            <motion.p className="text-base text-[#757575] mt-8 dark:text-neutral-300 hel-font">
